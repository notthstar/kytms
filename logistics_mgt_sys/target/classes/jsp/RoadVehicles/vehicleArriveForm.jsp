...
//        }
        ...
        function AcceptClick() {
            ...
            var postData={
                vehicleTime:$("#vehicleTime").val(),
                "shipment.id":keyValue
            }
            $.SaveForm({
                url: "/vehicleArrive/saveVehicleArrive.action",
                param: postData,
                loading: "正在保存数据...",
                success: function (data) {
                    if (data.type){
        ...
        //                    $("#zoneId").val(resule.id);
        //                    $("#zoneName").val(resule.name);
        //                }
        //            });
        //        }
        //
    ...
    <div style="margin-left: 10px; margin-right: 10px;">
        <table class="form">
            ...
            <tr>
                <td class="formTitle">到站时间<font face="宋体">*</font></td>
                <td class="formValue">
                    <input id="vehicleTime" type="text"  placeholder="请选择时间"   readonly="readonly"  class="form-control input-wdatepicker" isvalid="yes"  checkexpession="NotNull"  onfocus="WdatePicker()"/>
                </td>
            </tr>
            <tr>
