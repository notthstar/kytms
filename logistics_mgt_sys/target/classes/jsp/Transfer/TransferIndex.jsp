    ...
    function GetGrid() {
        ...
        $gridTable.jqGrid({
            ...
            colModel: [
                ...
                {label: '承运商', name: 'projectManagement.name', width: 160, align: 'center'},
                {label: '发货单号', name: 'name', width: 260, align: 'center'},
                {label: '货品名称', name: 'code', width: 200, align: 'center'},
                {label: '货品件数', name: 'code', width: 200, align: 'center'},
                {label: '货品体积', name: 'code', width: 200, align: 'center'},
                {label: '货品重量', name: 'code', width: 200, align: 'center'},
                {label: '中转日期', name: 'time', width: 200, align: 'center',
...
<div class="titlePanel">
    ...
    <div class="toolbar">
        <div class="btn-group">
            ...
            <a id="Transfer-edit" class="btn btn-default" onclick="btn_edit()"><i class="fa fa-pencil-square-o"></i>&nbsp;新增中转单</a>
        </div>
