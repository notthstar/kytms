    ...
    function GetGrid() {
        ...
        $gridTable.jqGrid({
            ...
            colModel: [
                ...
                {label: '车牌号', name: 'code', index:'code',width: 100,align: 'center'},
                {label: '数据状态', name: 'status', width: 80,align: 'center',frozen:true,type:"DD&CTZT",
                    formatter: function (cellvalue, options, rowObject) {
                        return top.clientdataItem.CommDataStatus['' + cellvalue + '']
                    }},
                {label: '所属机构', name: 'organization.name', width: 150, align: 'center'},
                {label: '司机', name: 'driver', width: 150, align: 'center'},
                {label: '电话', name: 'iphone', width: 150, align: 'center'},
                {label: '尺寸', name: 'size', index:'size',width: 100,align: 'center'},
                {label: '总质量(吨)', name: 'totalMass', width: 100,align: 'center'},
                {label: '牵引总质量(吨)', name: 'pullTotalMass', width: 100,align: 'center'},
                {label: '车架号', name: 'vin',width: 200,align: 'center'},
                {label: '发动机号', name: 'engineVin', width: 150,align: 'center'},
                {label: '创建人', name: 'create_Name',index:'create_Name', width: 100,align: 'center'},
                {label: '创建时间', name: 'create_Time',index:'create_Time',type:'date', width: 150,align: 'center',
                ...
                {label: '修改人', name: 'modify_Name',index:'modify_Name', width: 100,align: 'center'},
                {label: '修改时间', name: 'modify_Time',index:'modify_Time', type:'date', width: 150,align: 'center',
                    formatter:function(cellvalue, options, row){
                        if(cellvalue == null || cellvalue == undefined || cellvalue ==""){
                            return "";
                        }
...
//            },
    ...
    function btn_add() {
        dialogOpen({
            id: "VehicleHeadFrom",
            title: '添加车头信息',
            url: '/jsp/VehicleHead/VehicleHeadForm.jsp',
            width: "900px",
            height: "525px",
    ...
    function btn_edit(id) {
        ...
        if (checkedRow(keyValue)) {
            dialogOpen({
                id: "Form",
                title: '修改车头信息',
                url: '/jsp/VehicleHead/VehicleHeadForm.jsp?keyValue=' + keyValue,
                width: "900px",
                height: "525px",
                callBack: function (iframeId) {
                    top.frames[iframeId].AcceptClick();
