    ...
    <script>
        ...
        function queryReport(){
            ...
            if(xmmc != undefined && xmmc !='' && xmmc != null){
                var raq="广州日报表GJKHMC.raq"; //报表名称
                var url = getUrl+"?raq="+raq+"&id="+xmmc+"&bdate="+start+"&edate="+end//拼接请求请求连接并传入GET参数
            }else{
                var raq="广州日报表.raq"; //报表名称
                var url = getUrl+"?raq="+raq+"&bdate="+start+"&edate="+end//拼接请求请求连接并传入GET参数
            }
            dialogOpen({
                id: "guojitaizhang",
                title: '广州日报表',
