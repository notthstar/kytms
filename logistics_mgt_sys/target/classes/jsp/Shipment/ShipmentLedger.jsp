...
<script>
    ...
    //加载表格
    function GetGrid() {
        var url="/shipmentLedger/getShipmentLengerList.action";
        var selectedRowIndex = 0;
        var $gridTable = $('#gridTable');
        if(accountStatue!=null && accountStatue!=""){
            url="/shipmentLedger/getShipmentLengerList.action?status=0";
        }
        $gridTable.jqGrid({
            url: url,
            datatype: "json",
            ...
            colModel: [
                ...
                {label: '运单号', name: 'b.code', width: 220, align: 'center'},
                {label: '运单ID', name: 'b.shipment.id', hidden: true},
                {label: '运单日期', name: 'b.shipment.time', type:"date", width: 150, align: 'center',
                ...
                {label: '台账类型', name: 'a.type',type:"DD&Ledger", width: 90, align: 'center',
                    formatter:function(cellvalue, options, row){
                        return top.clientdataItem.Ledger['' + cellvalue + '']
                    }
                },
                {label: '数量', name: 'b.number', width: 80, align: 'center'},
                {label: '重量', name: 'b.weight', width: 80, align: 'center'},
                {label: '体积', name: 'b.volume', width: 80, align: 'center'},
                {label: '应付金额', name: 'a.amount', width: 80, align: 'center'},
                {label: '税率', name: 'a.taxRate', width: 80, align: 'center'},
                {label: '税金', name: 'a.input', width: 80, align: 'center'},
                {label: "状态", name: "a.status",type:"DD&CommDataStatus", width: 90, align: "center",
                ...
                {label: "结算CODE", name: "stt.code", width: 190, align: "center"},
            ],
            viewrecords: true,
            rowNum: 30,
            rowList: [30, 50, 100],
            ...
            subGridRowExpanded: function (subgrid_id, row_id) {
                ...
                $("#" + subgrid_table_id).jqGrid({
                    url: "/shipmentLedger/getShipmentLengerDetailList.action",
