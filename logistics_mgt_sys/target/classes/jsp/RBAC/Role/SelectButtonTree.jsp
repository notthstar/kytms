...
<form id="form1">
    ...
    <script type="text/javascript">
        ...
        function GetModuleTree() {
            var item = {
                height: 540,
                showcheck: true,
                url: "role/getRoleButtonList.action?id=" + roleId
            };
    ...
    <div class="widget-body">
        <div id="wizard" class="wizard" data-target="#wizard-steps"
            ...
            <ul class="steps">
                <li data-target="#step-1" class="active"><span class="step">*</span>按钮列表<span class="chevron"></span>
                </li>
            </ul>
        </div>
