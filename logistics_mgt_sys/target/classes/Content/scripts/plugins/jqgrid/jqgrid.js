                ...
                if (this.grid) {
                    ...
                    if (!0 !== b.p.subGrid && !0 !== b.p.treeGrid && !0 !== b.p.cellEdit && !b.p.sortable && !b.p.scroll) {
                        ...
                        if (0 <= k && e) {
                            ...
                            b.grid.fhDiv = a('<div style="position:absolute;left:0px;top:' + c + "px;height:" + (d+1) + 'px;" class="frozen-div ui-state-default ui-jqgrid-hdiv"></div>');
                ...
                if (c.grid && !0 === c.p.cellEdit) {
                    ...
                    if ("subgrid" !== g && "cb" !== g && "rn" !== g) {
                        ...
                        b.isFunction(c.p.onSelectCell) && c.p.onSelectCell.call(c, c.rows[d].id, g, e, d, f);
                            ...
                            //臧英明修改，当单元格失去焦点，则保存
                            b("input, select, textarea", h).bind("blur",
                                function (a) {
