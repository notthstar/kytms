...
<script>
    ...
    //新增
    function btn_add() {
        top.tablist.newTab({ id: "Form", title: "新增订单", closed: true, icon: "fa fa fa-user", url: top.contentPath+"jsp/CustomerService/Order/OrderForm.ftl" })
//        dialogContent({
//            id: "Form",
//            title: '新增订单',
//            url: 'jsp/CustomerService/Order/OrderForm.ftl',
//            width: "650px",
//            height: "420px",
