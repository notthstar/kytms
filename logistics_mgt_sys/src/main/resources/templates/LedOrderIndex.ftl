...
<script>
    ...
    function btn_edit(id) {
        ...
        if (checkedRow(keyValue)) {
            //top.tablist.newTab({ id: "orderForm", title: "修改订单", closed: true, icon: "fa fa fa-user", url: top.contentPath+"/jsp/TransportOrder/OrderForm.ftl?keyValue=" + keyValue })
            var options ={
                width: "1180px",
                height: "650px",
            }
            ...
            top.layer.open({
                ...
                fix: false,
                area: [_width, _height],
                content: top.contentPath +  '/jsp/TransportOrder/OrderForm.ftl?keyValue=' + keyValue,
                cancel: function () {
