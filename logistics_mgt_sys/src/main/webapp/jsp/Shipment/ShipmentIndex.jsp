    ...
    function GetGrid() {
        ...
        $gridTable.jqGrid({
            ...
            colModel: [
                ...
                {label: '运单日期', name: 'time', width: 150,align: 'center', type:"date",
                ...
                {label: "收入成本确认状态", name: "isInoutCome", index:"isInoutCome",width: 70, align: "center",type:"DD&ConfirmStatus"
                    // formatter: function (cellvalue, options, rowObject) {
                    //     return top.clientdataItem.ConfirmStatus['' + cellvalue + '']
                    // }
                    },
                {label: '车牌号', name: 'liens', width: 80,align: 'center'},
                ...
                {label: '总金额', name: 'amount', width: 60,align: 'center'},
                {label: '订单号', name: 'orderCode', width: 230, align: 'center'},
                {label: '客户订单号', name: 'relateBill', width: 200, align: 'center'},
                {label: '运作模式', name: 'operationPattern', width: 40,align: 'center',type:"DD&OperationPattern"
                    // formatter: function (cellvalue, options, rowObject) {
            ...
            subGridRowExpanded: function (subgrid_id, row_id) {
                ...
                $("#" + subgrid_table_id).jqGrid({
                    ...
                    colModel: [
                        ...
                        {label: '支付方式', name: 'payMethod', width: 100, align: 'center',editable:true,edittype:'select', editoptions: {value: top.clientdataItem.PayMethod}},
...
//                        feeTypeTotal($(this))
    ...
    function btn_add() {
        ...
        top.layer.open({
            ...
            fix: false,
            area: [_width, _height],
            content: top.contentPath +  '/jsp/Shipment/ShipmentForm.jsp?osType=shipment',
            cancel: function () {
...
<div class="titlePanel">
    ...
    <div class="toolbar">
        ...
        <div class="btn-group">
            <a id="shipment-export" class="btn btn-default" onclick="btn_export()"><i class="fa fa-pencil-square-o"></i>&nbsp;导出台账</a>
            <a id="replace" class="btn btn-default" onclick="reload();"><i class="fa fa-refresh"></i>&nbsp;刷新</a>
            <a id="shipment-add" class="btn btn-default" onclick="btn_add()"><i class="fa fa-plus"></i>&nbsp;新增</a>
            <a id="shipment-edit" class="btn btn-default" onclick="btn_edit()">&nbsp;编辑</a>
            <a id="shipment-print" class="btn btn-default" onclick="btn_print()">&nbsp;打印</a>
        </div>
        <div class="btn-group">
        ...
        <div class="btn-group">
            <a id="shipment-yd" class="btn btn-default" onclick="btn_yd()"><i class="fa fa-play"></i>&nbsp;运抵</a>
        </div>
        <div class="btn-group">
