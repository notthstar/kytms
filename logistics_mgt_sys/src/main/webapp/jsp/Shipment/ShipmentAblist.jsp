...
<script>
    ...
    function GetGrid() {
        ...
        $gridTable.jqGrid({
            url: "/shipment/getAbnormalList.action?id="+id,
            datatype: "json",
            ...
            colModel: [
                ...
                {label: '修改原因', name: 'description', width: 300, align: 'center'},
            ...
            subGridRowExpanded: function (subgrid_id, row_id) {
                ...
                $("#" + subgrid_table_id).jqGrid({
                    ...
                    colModel: [
                        ...
                        {label: '原有数据', name: 'sourceValue', width: 200, align: 'center'},
                        {label: '替换数据', name: 'targerValue', width: 200, align: 'center'},
