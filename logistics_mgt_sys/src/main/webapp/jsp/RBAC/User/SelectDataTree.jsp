...
<form id="form1">
    ...
    <script type="text/javascript">
        ...
        function GetModuleTree() {
            var item = {
                height: 540,
                showcheck: true,
                url: "/user/getOrgTree.action?id=" + userId
            };
        ...
        function AcceptClick() {
            ...
            $.SaveForm({
                url: "/user/saveUserOrg.action",
                param: {id: userId, ids: selectedData},
                loading: "正在保存数据...",
    ...
    <div class="widget-body">
        <div id="wizard" class="wizard" data-target="#wizard-steps"
            ...
            <ul class="steps">
                <li data-target="#step-1" class="active"><span class="step">*</span>授权列表<span class="chevron"></span>
                </li>
            </ul>
        </div>
