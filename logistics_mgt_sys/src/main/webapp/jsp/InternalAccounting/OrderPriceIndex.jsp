    ...
    function GetGrid() {
        ...
        $gridTable.jqGrid({
            ...
            colModel: [
                ...
                {label: '费用类型', name: 'organization.name',index:'jvh.organization.name', width: 150, align: 'center'},
                {label: '吨单价', name: 'organization1.name',index:'jvh.organization1.name', width: 150, align: 'center'},
                {label: '方单价',selectDefault:true,name: 'code',index:'jvh.code', width: 100,align: 'center'},
                {label: '税率', name: 'driver.name',index:'dri.name', width: 100,align: 'center'},
