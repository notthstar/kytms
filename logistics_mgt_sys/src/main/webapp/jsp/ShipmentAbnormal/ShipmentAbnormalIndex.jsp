...
<script>
    ...
    function GetGrid() {
        ...
        $gridTable.jqGrid({
            url: "/abnormal/getOrderAbnormalList.action?whereValue=1",
            datatype: "json",
            height: $(window).height() - 136.5,
            autowidth: true,
            colModel: [
                {label: '主键', name: 'id', hidden: true},
                {label: '组织机构Id', name: 'organization.id', hidden: true},
                {label: '运单ID', name: 'shipment.id', hidden: true},
                {label: '组织机构', name: 'organization.name', width: 160, align: 'center'},
                {label: '异常类型', name: 'type', width: 80, align: 'center',type:"DD&abnormalType",
                    formatter: function (cellvalue, options, rowObject) {
                        return top.clientdataItem.abnormalType['' + cellvalue + '']
                    }},
                ...
                {label: '运单状态', name: 'shipment.status', width: 80, align: 'center',type:"DD&OrderStatus",
                    formatter: function (cellvalue, options, rowObject) {
